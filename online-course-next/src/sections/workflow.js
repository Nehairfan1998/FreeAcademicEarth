...
const workflowData = [
  {
    title: 'No Signups',
    text:
      'User does not need to signup or fill any form to get started.',
  },
  {
    title: 'Start Learning',
    text:
      'Get started on hassle free journey of learning.',
  },
  {
    title: 'Easy to use',
    text:
      'Our user experience is designed to get along with any person.',
  },
  {
    title: 'Eventaully get a job',
    text:
      'Keep learning and land your dream tech job. Good Luck',
  },
];
