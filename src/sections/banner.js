          ...
          <Box sx={styles.banner.col}>
            <Box sx={styles.banner.content}>
              ...
              <Text as="p">
                ...
                <br />
                It requires careful planning and implementation . "In order to
                create an engaging learning experience the role of instructor is
                optional, but the role of learner is essential."
              </Text>
